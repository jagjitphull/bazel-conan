...
def load_conan_dependencies():
    native.new_local_repository(
        ...
        build_file="/home/ilg/bazel-conan/bazel-conan-CI-demo8/conan/fmt/BUILD.bazel",
    )
    native.new_local_repository(
        name="nlohmann_json",
        path="/home/ilg/.conan2/p/nlohm0567ffc90cfc1/p",
        build_file="/home/ilg/bazel-conan/bazel-conan-CI-demo8/conan/nlohmann_json/BUILD.bazel",
    )
